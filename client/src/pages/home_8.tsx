...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (refCode) {
      ...
      toast({ title: "Referral Link Detected!", description: "Sign up to help your friend!" });
    }
  }, [toast]);
          ...
          <div className="max-w-7xl mx-auto">
            <div className="relative rounded-2xl overflow-hidden border border-gold/20 mb-16" style={{ background: 'linear-gradient(135deg, rgba(18, 38, 32, 0.95), rgba(28, 45, 36, 0.95))' }}>
              <div className="px-8 py-16 md:py-24 text-center">
                <img src="https://files.catbox.moe/95hr3x.png" alt="Logo" className="w-32 h-32 mx-auto mb-6" />
                ...
                <p className="text-xl text-cream/80 mb-8 max-w-3xl mx-auto">Premium followers, likes, views from ₹11/1000</p>
