...
interface Festival {
  name: string; nameHindi: string; date: Date; emoji: string; discount: number; color: string;
  startDaysBefore: number; endDaysAfter: number; messageHi: string; messageEn: string;
}

function getFestivalsForYear(year: number): Festival[] {
  return [
    { name: "New Year", nameHindi: "नया साल", date: new Date(year, 0, 1), emoji: "🎉", discount: 45, color: "from-purple-600/40 via-pink-600/30 to-yellow-600/40", startDaysBefore: 5, endDaysAfter: 3, messageHi: "नया साल धमाका - 45% छूट के साथ नई शुरुआत करो!", messageEn: "NEW YEAR - 45% OFF!" },
    { name: "Republic Day", nameHindi: "गणतंत्र दिवस", date: new Date(year, 0, 26), emoji: "🇮🇳", discount: 26, color: "from-orange-600/40 via-white/10 to-green-600/40", startDaysBefore: 4, endDaysAfter: 1, messageHi: "गणतंत्र दिवस - सभी सर्विस पर 26% छूट - जय हिंद!", messageEn: "REPUBLIC DAY - 26% OFF!" },
    { name: "Holi", nameHindi: "होली", date: new Date(year, 2, 3), emoji: "🎨", discount: 35, color: "from-pink-600/40 via-yellow-500/30 to-green-600/40", startDaysBefore: 5, endDaysAfter: 2, messageHi: "होली धमाका - अपने फीड में रंग भरो - 35% छूट!", messageEn: "HOLI - 35% OFF!" },
    ...
    { name: "Diwali", nameHindi: "दीवाली", date: new Date(year, 9, 20), emoji: "🪔", discount: 50, color: "from-yellow-500/40 via-orange-600/40 to-red-600/40", startDaysBefore: 10, endDaysAfter: 3, messageHi: "दीवाली धमाका - सबसे बड़ी सेल 50% छूट - शुभ दीपावली!", messageEn: "DIWALI BIGGEST SALE - 50% OFF!" },
    { name: "Navratri", nameHindi: "नवरात्रि", date: new Date(year, 9, 2), emoji: "💃", discount: 40, color: "from-red-600/40 via-yellow-600/30 to-orange-600/40", startDaysBefore: 5, endDaysAfter: 9, messageHi: "नवरात्रि धमाका - 9 दिन 40% छूट - जय माता दी!", messageEn: "NAVRATRI - 40% OFF!" },
  ];
}
      ...
      <div className="relative overflow-hidden backdrop-blur-md bg-gradient-to-r from-gold/25 via-yellow-500/20 to-gold/25 border-b border-gold/40 shadow-lg">
        <div className="flex whitespace-nowrap animate-marquee py-3">
          ...
          <span className="text-sm font-bold text-gold flex items-center gap-3 ml-12">
            <span>🚀</span>
            <span className="text-white">इंस्टाबूस्ट प्रो - भारत का नंबर 1 - रियल फॉलोअर्स ₹11/1000</span>
            <span className="mx-3 bg-gold/20 px-3 py-1 rounded-full">50% छूट</span>
            <span>🎉 त्योहारों पर बम्पर ऑफर ऑटो अपडेट!</span>
          </span>
        </div>
      </div>
    </div>
