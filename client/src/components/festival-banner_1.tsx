...
export function FestivalBanner() {
  ...
  useEffect(() => {
    fetch('/api/settings/banner').then(res => res.json()).then(data => {
      ...
      else { setBannerText("इंस्टाबूस्ट प्रो - भारत का नंबर 1 SMM पैनल - रियल फॉलोअर्स ₹11/1000 - 5 दोस्तों को रेफर करो और पाओ 50% लाइफटाइम छूट"); }
    }).catch(() => { setBannerText("इंस्टाबूस्ट प्रो - भारत का नंबर 1 SMM पैनल - रियल फॉलोअर्स ₹11/1000 - 5 दोस्तों को रेफर करो और पाओ 50% लाइफटाइम छूट"); });
  }, []);
